        ...
        <div class="main" >
            ...
            <div class="delivery btn-group">
				...
				<div>
                   ...
                   <label><input type="radio" name="delivery" >Pickup from shop</label>
            </div>
            <div class="payment">
            ...
            <div class="btn-group">
                ...
                <button class="flex-c-m stext-101 cl0 size-101 bg3 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail"  >Every Day</button>
                <button class="flex-c-m stext-101 cl0 size-101 bg3 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail"  >Alternative Day</button>
                <button class="flex-c-m stext-101 cl0 size-101 bg3 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail"  >Every Week</button>
                <button class="flex-c-m stext-101 cl0 size-101 bg3 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail"  >Every Month</button>
            </div>
                <br /><br />
            <div>
                <button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail"   type="submit" form=" " value="Submit">Place Order list</button>
            </div>
        </div>
        </div>
<!--Footer Starts-->
