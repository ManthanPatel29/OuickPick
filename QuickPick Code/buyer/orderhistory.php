<?php  
		...
		$ord="Select * from order_master where Email_ID='$user_check' ";
...
<!--							<div class="wrap-table-shopping-cart">-->
								...
								{
								?>
<!--								<table border="0" height="150px" align="center">-->
									<tr>
								...
								<?php
									...
									{
										$product = $order["Seller_ID"];
										$pid= $order['P_ID'];
										$qty = $order['Quantity'];
										$total = $order['Total'];
										$string = $order['delivery'];
										$date = $order['date'];
										$pro="Select * from seller_master where Seller_ID='$product' ";
		 								$proresult = mysqli_query($connect,$pro);
										if( mysqli_num_rows($proresult) > 0)
										{	
											while($seller = mysqli_fetch_assoc($proresult))
											{
								...
								?>
										<tr>
											...
											?>
											<td class="column-7">
													<p><?php echo $seller['Shop_No']; ?>,
											
													<?php echo $seller['Shop_name']; ?>,
											
													<?php echo $seller['Near_by']; ?></p>
											</td>	
											<?php 
												}
												else
